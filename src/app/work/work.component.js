...
var WorkComponent = (function () {
    function WorkComponent(campusLinksService, location, router) {
        var _this = this;
    ...
    WorkComponent.prototype.getUrl = function (term) {
        this.url = term;
        return this.url;
    };
    WorkComponent.prototype.goBack = function () {
        this.location.back();
    };
    WorkComponent.prototype.gotoSchool = function () {
        this.router.navigate(['/school']);
    };
    WorkComponent.prototype.gotoCommunication = function () {
        this.router.navigate(['/communication']);
    };
    WorkComponent.prototype.gotoFavorites = function () {
        this.router.navigate(['/favorites']);
    };
    WorkComponent.prototype.goHome = function () {
